...
export default function ExecutionPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const [techData, setTechData] = useState<any>({
    ...
    servicedEquipmentIds: [], // IDs de los extintores específicos atendidos
    observations: "",
    clientSignatureName: "",
  })
  ...
  const handleFinish = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Actualizar la "Hoja de Vida" de cada equipo marcado
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 pb-20">
      ...
      <form onSubmit={handleFinish} className="space-y-6">
        {/* EQUIPOS DEL CLIENTE (VINCULACIÓN) */}
        {isExtinguisher && equipment && equipment.length > 0 && (
          <Card className="shadow-sm border-none bg-white">
            ...
            <CardContent className="pt-6 space-y-3">
              <p className="text-[10px] font-bold text-muted-foreground uppercase mb-4">Seleccione los equipos del inventario que está atendiendo hoy:</p>
